...
class DrawAttention_ImportExport {
	...
	public function admin_menu() {
		...
		add_submenu_page( 'edit.php?post_type=da_image', __( 'Import / Export', 'drawattention' ), __( 'Import / Export', 'drawattention' ), 'manage_options', 'import_export', array( $this, 'output_import_export_page' ) );
	}
