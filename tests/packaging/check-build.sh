...
for p in external documentation tests .github node_modules build Gruntfile.js package.json package-lock.json composer.json composer.lock CHANGELOG.md CODEOWNERS; do
